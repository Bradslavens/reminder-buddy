      ...
      <div>
        <tr>
          <td><?php if($checklist_item['all_signed'] == 0){ echo "Incomplete"; }else{echo "Complete"; } ?><br />
            <a href="<?php echo site_url('proc/processing/checklist/del_item/' . $checklist_item['id']); ?>"><span title = "Click to Delete this item" class="glyphicon glyphicon-trash" aria-hidden="true"></span></a> 
